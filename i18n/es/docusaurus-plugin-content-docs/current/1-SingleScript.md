...
1. **Descarga phoenixd v0.6.2** de los lanzamientos oficiales de ACINQ en GitHub.
...
-----------------------------------------
Instalando phoenixd 0.6.2 desde github.com/ACINQ/phoenixd/releases/download/v0.6.2
```
